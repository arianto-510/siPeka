                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        ...
                        @auth
                            <div class="intro-excerpt">
                                ...
                                <p><a href="/menu" class="btn btn-secondary me-2">Menu</a></p>
                            </div>
                        @else
                            <div class="intro-excerpt">
                                <h1 class="mb-4">Cari Makanan dan Minuman ? <span class="d-block">Lia Cafe & Resto</span>
                                </h1>
                                <p class="my-3">Sistem Informasi Pengelolahan Cafe&Resto</p>
                                <p><a href="/kontak" class="btn btn-secondary me-2">Kontak</a></p>
                            </div>
                    ...
                    <div class="col-lg-7">
                        <div class="hero-img-wrap">
                            <img src="{{ url('front-end/images/banner.png') }}" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
